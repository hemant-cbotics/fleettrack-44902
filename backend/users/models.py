...
class UserAccount(CommonModel):
    ...
    harsh_braking = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    harsh_acceleration = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    speeding = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    reverse = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    seatbelt_off = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    harsh_cornering = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    idle_ratio = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    impact_crash_ai = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    cellphone_use_ai = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    distracted_driving_ai = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    smoking_ai = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    possible_fatigue_ai = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
    obstructed_camera_ai = models.CharField(max_length=20, choices=UserConstants.ZeroToTenInteger.choices(), default=UserConstants.ZeroToTenInteger.Zero.value, null=True, blank=True)
