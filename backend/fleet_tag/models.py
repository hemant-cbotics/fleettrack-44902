...
class FleetTag(CommonModel):
    ...
    """
    fleet_tag_id = models.CharField(max_length=255, null=True, blank=True)
    fleet_tag_name = models.CharField(max_length=255, default=None, null=True, blank=True, unique=True)
    last_event_time = models.DateTimeField(null=True, blank=True, default=None)
    ...
    distance_traveled = models.CharField(max_length=255, null=True, blank=True, help_text="Distance traveled in miles")
    ...
    temperature = models.CharField(max_length=255, null=True, blank=True, help_text="Temperature in Fahrenheit")
