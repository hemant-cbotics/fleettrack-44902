"""
Django settings for fleettrack_44902 project.
...
ROOT_URLCONF = 'fleettrack_44902.urls'
...
WSGI_APPLICATION = 'fleettrack_44902.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fleettrack_44902 API",
    "DESCRIPTION": "API documentation for fleettrack_44902 App",
    "VERSION": "v1",
}
