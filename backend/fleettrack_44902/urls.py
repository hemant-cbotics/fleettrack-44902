"""fleettrack_44902 URL Configuration
...
urlpatterns = [
    ...
    path("organization/", include("organization.api.v1.urls", namespace="organization")),
    path("vehicle/ap1/v1/", include("vehicle.api.v1.urls", namespace="vehicle")),
...
admin.site.site_header = "FleetTrack"
admin.site.site_title = "FleetTrack Admin Portal"
admin.site.index_title = "FleetTrack Admin"
