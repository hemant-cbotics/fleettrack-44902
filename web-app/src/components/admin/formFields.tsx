  ...
  return (
    ...
    >
      ...
      <input
        ...
        value={value}
        disabled={disabled}
        className={`mt-1 w-full h-11 px-3 disabled:bg-gray-200 disabled:border-gray-300 rounded-md bg-white text-sm shadow-sm focus-visible:outline-4 focus-visible:shadow-none${
          touched ? " touched" : ""
