  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      const data = {
        ...
        licence_expiry: new Date(values.license_expiration).toISOString(),
        ...
        unique_id_last_change: new Date(values.unique_id_last_change).toISOString(),
    ...
    <>
      ...
      <div className={`${APP_CONFIG.DES.DASH.P_HORIZ} py-2`}>
        ...
        <div className="lg:grid lg:grid-cols-12 mt-8 py-2 gap-4">
          ...
          <div
            className={`${
              isNewEntity?.current ? "lg:col-span-12" : "lg:col-span-9"
            }`}
          >
